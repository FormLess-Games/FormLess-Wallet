...
export const UPDATE_ACCOUNT_NFT_TOKENS = 'UPDATE_ACCOUNT_NFT_TOKENS';
...
// Home Screen
export const HOME_SWITCH = 'HOME_SWITCH';

export const UPDATE_INDEX_SORT = 'UPDATE_INDEX_SORT';

export const UPLDATE_PRIORITY_LINK = 'UPLDATE_PRIORITY_LINK';
