...
export default function reduceMetamask(state = {}, action) {
  ...
  switch (action.type) {
    ...
    case actionConstants.UPDATE_ACCOUNT_NFT_TOKENS:
      return {
        ...metamaskState,
        accountNFTTokens: action.accountNFTTokens,
      };
    ...
    case actionConstants.UPLDATE_PRIORITY_LINK:
      return {
        ...metamaskState,
        priorityLink: action.value,
      };
