...
export function getIndexSort(state) {
  return state.appState.indexSort;
}
...
export function getAccountNFTTokens(state) {
  return state.metamask.accountNFTTokens;
}
...
export function getMetaMask(state) {
...
export function getTabActive(state) {
...
export function getIsMatic(state) {
  const chainId = getCurrentChainId(state);
