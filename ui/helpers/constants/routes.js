...
const ASSET_NFT_ROUTE = '/asset-nft';
...
const ADD_NFT_TOKEN_ROUTE = '/add-nft-token';
...
const INITIALIZE_IMPORT_WITH_SEED_PHRASE_ROUTE2 =
  '/initialize/create-password/import-with-seed-phrase2';
...
const PATH_NAME_MAP = {
  ...
  [`${ASSET_NFT_ROUTE}/:asset`]: `Asset Page`,
  ...
  [ADD_NFT_TOKEN_ROUTE]: 'Add NFT Token Page',
