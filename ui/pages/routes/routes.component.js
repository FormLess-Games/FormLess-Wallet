...
import SendNFTTransactionScreen from '../send-nft';
...
import AddNFTTokenPage from '../add-nft-token';
...
import AssetNFT from '../asset-nft';
import { EthOverviewCustom } from '../../components/app/wallet-overview';
import { toChecksumHexAddress } from '../../../shared/modules/hexstring-utils';
import { shortenAddress } from '../../helpers/utils/util';
import SelectedAccount from '../../components/app/selected-account';
import {
  ADD_TOKEN_ROUTE,
  ADD_NFT_TOKEN_ROUTE,
  ASSET_ROUTE,
...
export default class Routes extends Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    console.log(this.props, this, 'PPROPS');
    if (!currentCurrency) {
      setCurrentCurrencyToUSD();
    }
  ...
  renderRoutes() {
    ...
    const routes = (
      <Switch>
        ...
        <Authenticated
          path={SEND_NFT_ROUTE}
          component={SendNFTTransactionScreen}
          exact
        />
        <Authenticated path={SWAPS_ROUTE} component={Swaps} />
        <Authenticated path={ADD_TOKEN_ROUTE} component={AddTokenPage} exact />
        <Authenticated
          path={ADD_NFT_TOKEN_ROUTE}
          component={AddNFTTokenPage}
          exact
        />
        <Authenticated
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {!this.hideAppHeader() && isUnlocked && (
          <div className="main-container-coincode">
            <span
              className={!tabActive ? 'an' : ''}
              onClick={() => {
                this.setState({ tabActive: false });
                this.props.setTabActive(false);
                this.props.onTabClick(this.context.t('numberAsset'));
              }}
            >
            ...
            <span
              ...
              onClick={() => {
                ...
                this.props.setTabActive(true);
                this.props.onTabClick(`NFT${this.context.t('asset')}`);
              }}
            >
              NFT
            </span>
        ...
        {!this.hideAppHeader() && isUnlocked && (
          <div className="main-container-money">
            <EthOverviewCustom />
            {/* <span>$0.00</span>
            <em>≈$0.00 USD</em> */}
          </div>
        )}
        {!this.hideAppHeader() && isUnlocked && <SelectedAccount />}
        <Sidebar
