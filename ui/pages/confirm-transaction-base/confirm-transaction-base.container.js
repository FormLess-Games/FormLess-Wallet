...
const mapStateToProps = (state, ownProps) => {
  console.log(state, ownProps, 'ownPropsownPropsownProps');
  const {
  ...
  console.log(state, ownProps, data, 'state, ownPropsstate, ownProps');
  const { localeMessages } = state;
  return {
    label:
      networkType === NETWORK_TYPE_RPC
        ? networkNickname ?? localeMessages.current['privateNetwork']
        : localeMessages.current[networkType],
    balance,
    fromAddress,
    fromName,
    toAddress,
