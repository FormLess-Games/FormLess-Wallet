...
import TokenSearchMatic from './token-search-matic';
...
class AddToken extends Component {
  ...
  static propTypes = {
    ...
    isMatic: PropTypes.bool.isRequired,
        ...
        {isMatic ? (
          <TokenSearchMatic
            onSearch={({ results = [], searchQuery }) =>
              this.setState({ searchResults: results, searchQuery })
            }
