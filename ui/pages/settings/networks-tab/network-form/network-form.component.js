      ...
      <div className="networks-tab__network-form">
        ...
        <div className="network-form__footer">
          {!viewOnly && (
            <>
              {deletable && (
                <div className="network-form__button" onClick={this.onDelete}>
                  {t('delete')}
                </div>
              )}
              <div
                className="network-form__button network-form__button-cancel"
                type="default"
              ...
              <div
                className="network-form__button network-form__button-save"
                type="secondary"
