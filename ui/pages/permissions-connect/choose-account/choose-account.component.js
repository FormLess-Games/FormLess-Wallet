          ...
          return (
            ...
            >
              <div className="permissions-connect-choose-account__account-info-wrapper">
                <div className="permissions-connect-choose-account__account-info-wrapper__left">
        ...
        <div className="permissions-connect-choose-account__footer-container">
          ...
          <div className="permissions-connect-choose-account__bottom-buttons">
            <div
              ...
              className="permissions-connect-choose-account__bottom-buttons__cancel"
            >
              {t('cancel')}
            </div>
            <div
              onClick={() =>
                selectedAccounts.size && selectAccounts(selectedAccounts)
              }
              className={`${
                selectedAccounts.size ? '' : 'an'
              } permissions-connect-choose-account__bottom-buttons__next`}
            >
              {t('next')}
            </div>
          </div>
