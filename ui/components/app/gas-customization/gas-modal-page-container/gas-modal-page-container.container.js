...
const mapDispatchToProps = (dispatch) => {
  const updateCustomGasPrice = (newPrice) =>
    dispatch(setCustomGasPrice(decGWEIToHexWEI(newPrice)));
  ...
  return {
    ...
    updateCustomGasLimit: (newLimit) =>
      dispatch(setCustomGasLimit(decimalToHex(newLimit))),
...
function calcCustomGasPrice(customGasPriceInHex) {
  const value = Number(hexWEIToDecGWEI(customGasPriceInHex));
  console.log(value, customGasPriceInHex);
  return value;
}
