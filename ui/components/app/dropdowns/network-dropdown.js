...
class NetworkDropdown extends Component {
    ...
    return reversedRpcListDetail.map((entry) => {
      ...
      return (
        <div
          ...
          key={rpcUrl}
          className="network-dropdown-content-li"
        >
          <span
            className={`color-indicator--filled color-indicator--border-color-white`}
          ></span>
          <div className="cont">{nickname || rpcUrl}</div>
          {isCurrentRpcTarget ? <img src="./images/nike.png" /> : ''}
        </div>
  ...
  handleTabClick(newProviderType) {
    const { setProviderType, onClickOutside, hideNetworkDropdown } = this.props;
    setProviderType(newProviderType);
    hideNetworkDropdown();
  }
  ...
  render() {
    const {
      provider: { rpcUrl: activeNetwork, type: providerType },
    ...
    return (
      ...
      <>
        {isOpen && (
          <div
            className="network-dropdown-network-content-position"
            onClick={() => hideNetworkDropdown()}
          >
            <div className="network-dropdown-network-content">
              <div className="header">{this.context.t('networks')}</div>
              <div className="network-dropdown-content-list">
                {['mainnet', 'rinkeby'].map((item) => (
                  <div
                  ...
                  >
                    <span
                      className={`color-indicator--filled color-indicator--border-color-${item}`}
                    ></span>
                    <div className="cont">{this.context.t(item)}</div>
                    {providerType === item ? (
                ...
                <div
                  className="network-dropdown-content-bot"
                  onClick={() => {
                ...
                >
                  <span></span>
                  <div>{this.context.t('customNetwork')}</div>
                </div>
              </div>
            </div>
          </div>
