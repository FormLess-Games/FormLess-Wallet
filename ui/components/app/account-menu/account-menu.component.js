  ...
  renderAccounts() {
    ...
    return filteredIdentities
      .filter((identity, index) => {
        return (
          filteredIdentities.findIndex(
            (items) => items.address === identity.address,
          ) === index
        );
      })
      .map((identity) => {
        ...
        const addressDomains =
          addressConnectedDomainMap[identity.address] || {};
  ...
  render() {
    ...
    return (
      <div className="account-menu">
        ...
        <div className="account-menu__header">{t('myAccounts')}</div>
