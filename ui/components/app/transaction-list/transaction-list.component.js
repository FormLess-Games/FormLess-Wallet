...
export default function TransactionList({
  ...
  const metamask = useSelector(getMetaMask);
  ...
  console.log(nftList, 'nftListnftList');
  ...
  console.log(metamask, nftList, 'nftListnftList', completedTransactions);
    ...
    <div className="transaction-list">
      <div className="transaction-list__transactions">
        ...
        <div className="transaction-list__completed-transactions">
          ...
          {pendingLength === 0 && completedTransactions.length === 0 && (
