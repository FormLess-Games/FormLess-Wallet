...
async function initialize() {
  ...
  log.debug('FormLess initialization complete.');
}
 ...
 * @returns {Promise<MetaMaskState>} Last data emitted from previous instance of FormLess.
 */
async function loadStateFromPersistence() {
  ...
  if (versionedData && !versionedData.data) {
    ...
    sentry.captureMessage('FormLess - Empty vault found - unable to recover');
  }
  ...
  if (!versionedData) {
    throw new Error('FormLess - migrator returned undefined');
  }
  ...
  if (localStore.isSupported) {
    ...
    setTimeout(() => {
      throw new Error('FormLess - Localstore not supported');
    });
  }
...
/**
 * Initializes the FormLess Controller with any initial state and default language.
